...
const FilterModal: React.FC<CreateReportModalProps> = ({
  showSlideshow,
  setShowSlideshow,
  updateFilterData
}) => {
                ...
                <Dialog.Panel className="w-full max-w-lg h-fit mt-20 pt-8 transform overflow-hidden bg-white p-6 text-left align-middle  transition-all">
                  ...
                  <Formik
                    ...
                    onSubmit={(values: FormValues) => {
                      const query = {
                        mission: selectedMission.name === "Search" ? '' : selectedMission.name,
                      };
                    ...
                    {({ values, touched, isValid, setFieldValue, errors }) => (
                      <Form>
                        <div className="w-full">
                            ...
                            <div className="relative">
                              ...
                              >
                                <div className="relative mt-1 w-full">
                                  <Listbox.Button className="relative w-full cursor-default items-center rounded-lg bg-white py-2 pl-2 pr-2 text-left ring-1 ring-gray  ">
                                  ...
                                  >
                                    ...
                                    >
                                      {sortby.map((material, materialIdx) => (
                                        <Listbox.Option
                                          key={materialIdx}
                                          className={({ active }) =>
                          ...
                          <div className="border-t border-gray mt-8 mb-8"></div>
                          <div className="mt-5">
                            <div className="font-primary text-sm font-semibold text-graystrongest">
                              Mission Name
                            </div>
                          ...
                          <div className="flex mt-10">
                            <button
                              type="button"
                              onClick={resetHandle}
                              className="mt-5 flex w-40 items-center justify-center gap-2 rounded-md bg-primary px-2 py-2 text-sm font-medium text-white hover:bg-opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 mr-1"
                            >
                              Reset Filters
                            </button>
                            <button
                              type="submit"
                              className="mt-5 ml-1 flex w-full items-center justify-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
                            >
                              <Image
